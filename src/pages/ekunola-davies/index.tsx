	...
	return (
		<>
			...
			<main className="w-full">
				<div className="relative grid h-screen w-full place-items-center">
					<div className="absolute left-0 top-0 !z-[2] flex h-full w-full flex-col items-center justify-end bg-black/50 py-20">
						<div className="text-white">
							<p className="text-xl font-medium lg:text-2xl">Prophetic Evangelist</p>
							<h1 className="text-5xl font-light lg:text-9xl">Ekunola Davies</h1>
						</div>
					</div>
					<video
				...
				<section className="container mx-auto grid grid-cols-1 items-center gap-10 px-4 py-10 lg:grid-cols-2 lg:px-0 lg:py-20">
					<div className="flex w-full flex-col gap-3">
						<p className="text-xl font-bold lg:text-2xl">Ekunola Davies</p>
				...
				<section className="container mx-auto flex flex-col items-center gap-10 px-4 py-10 lg:px-0 lg:py-20"></section>
			</main>
			<Footer />
		</>
	)
